...
| Caminho | O que é |
|---|---|
| `src/pages/` | Páginas da wiki: home, entrada, temporada, linha do tempo, perfil, erro; e o perfil público do membro (`MemberPage`, rota `/@nome`, estilo em `src/styles/member.css`). |
